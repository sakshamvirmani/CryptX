...
const HomeComnponent = () => {
    ...
    const MyDrawerContent: React.FC<DrawerProps> = ({ children }) => {
        ...
        return <DrawerContent>{children}</DrawerContent>  //fix the error
    };
        ...
        <div>
            ...
            <div className={"flex flex-wrap items-center justify-center"}>
                ...
                <div className='flex gap-8 flex-wrap items-center ml-2 md:justify-center justify-around mt-5 md:mt-0'>
                    ...
                    <p className='flex justify-center items-center w-32 h-9 rounded-md greyBackground cursor-pointer interFont scalee gap-2' onClick={onOpen}>  <AiOutlineStar className='text-xl' /> Your Profile </p>
                </div>
            ...
            <div className="w80 mx-auto bg-amber-50 mt-4"></div>
            <br />
            <br />
            <br />
            ...
            <div className='flex gap-4 flex-wrap justify-center'>
                {pages.map((item) => {
                    ...
                    return (
                        <p key={item} className={active == item ? "bg-yellow-400 first-letter: text-white indivitualPage2 font-semibold cursor-pointer" : "indivitualPage font-semibold cursor-pointer"} onClick={(e) => {
            ...
            <Drawer onClose={onClose} isOpen={isOpen}>
                <DrawerOverlay />
                <DrawerContent>
                    <DrawerHeader borderBottomWidth='1px'> <div className='flex gap-2'>  <span className='font-semibold'>Your Collections</span> <AiFillStar className='golden font-bold text-3xl' /> </div> </DrawerHeader>
                    <DrawerBody>
                        <br />
